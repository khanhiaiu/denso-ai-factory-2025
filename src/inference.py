...
if __name__ == "__main__":
    ...
    # Improved device detection: check if CUDA is actually supported by the current torch install
    ...
    if torch.cuda.is_available():
        try:
            ...
            print("Warning: CUDA is available but incompatible with this PyTorch version. Using CPU.")
            device = torch.device("cpu")
